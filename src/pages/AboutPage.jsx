...
import { 
  Shield, Target, Users, Zap, Award, Briefcase, Globe, Activity, 
  Terminal, Eye, Cpu, Search, Database, Fingerprint, MessageCircle, ShieldCheck 
} from 'lucide-react';
...
const Card = ({ icon: Icon, title, description, index }) => (
  ...
  >
    ...
    <div className="relative z-10">
      ...
      <p className="text-gray-600 text-[13px] leading-relaxed font-semibold group-hover:text-gray-700 transition-colors uppercase tracking-wide italic">"{description}"</p>
    </div>
...
const MethodologyStep = ({ title, desc, icon: Icon, index }) => (
  <div className="flex gap-6 group">
    ...
    <div className="pt-1">
      <h4 className="text-xl font-bold text-gray-800 uppercase tracking-tight mb-2 group-hover:text-[#004a8e] transition-colors">{title}</h4>
      <p className="text-gray-500 text-[13px] leading-relaxed max-w-sm font-medium italic">{desc}</p>
    </div>
  </div>
);
    ...
    <div className="relative min-h-screen bg-[#f8fafc] text-gray-900 overflow-hidden font-sans pt-32 pb-24">
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-12 relative z-10 space-y-24">
        ...
        <section className="relative flex items-center justify-center pt-10">
          <motion.div style={{ opacity, scale }} className="relative z-10 w-full max-w-5xl text-center">
            <div className="inline-flex items-center gap-3 bg-white border border-gray-100 px-4 py-1.5 rounded-full shadow-sm mb-12">
                ...
                <span className="text-gray-400 font-bold text-[10px] uppercase tracking-[0.4em]">Academic Archive // Institutional History</span>
            </div>
            ...
            <p className="text-gray-600 text-xl md:text-2xl font-medium tracking-tight leading-relaxed max-w-3xl mx-auto italic">
            ...
            <div className="flex items-center justify-center gap-6 mt-16">
                ...
                <div className="flex items-center gap-4 bg-white border border-gray-100 px-6 py-4 rounded-2xl shadow-sm">
                   <Cpu className="text-[#004a8e]" size={20} />
                   <div className="text-left">
                      <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest leading-none mb-1">Grid_Status</p>
                      <p className="text-lg font-black text-[#004a8e] italic tracking-tighter leading-none">99.9% SECURE</p>
                   </div>
                </div>
                <div className="h-[1px] w-20 bg-gray-200"></div>
            </div>
        ...
        <section className="relative">
          <div className="grid lg:grid-cols-2 gap-16 items-center bg-white border border-gray-100 p-8 md:p-16 rounded-[4rem] shadow-2xl shadow-blue-900/5 relative">
             ...
             <div>
               ...
               <p className="text-gray-500 text-lg font-medium leading-relaxed mb-12 max-w-sm">
                 How we bridge the gap between academic theory and tactical defense through scientifically proven protocols.
               </p>
               ...
               <div className="space-y-3">
                 {["IDENTIFICATION", "ACQUISITION", "SYNTHESIS"].map(item => (
                   <div key={item} className="flex justify-between items-center bg-gray-50 px-6 py-4 rounded-xl border border-gray-100">
                      ...
                      <span className="text-[9px] font-bold text-gray-400 uppercase tracking-widest">ISO_LEVEL_A</span>
                   </div>
                 ))}
               </div>
             </div>
             ...
             <div className="space-y-12">
                ...
                <MethodologyStep index={1} title="Pattern Synthesis" desc="Expert node analysis to detect anomalies across digital streams and behavioral signatures." icon={Fingerprint} />
        ...
        <section className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white border border-gray-200 p-12 rounded-[3rem] shadow-xl shadow-blue-900/5 relative overflow-hidden group">
             ...
             <h3 className="text-4xl font-extrabold uppercase tracking-tighter text-gray-800 mb-4">OUR MISSION</h3>
             <p className="text-gray-600 text-lg font-medium leading-relaxed italic">"To deliver elite investigation modules, tactical personnel training, and military-grade intelligence roadmaps for modern investigators."</p>
        ...
        <section className="space-y-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card index={0} icon={Zap} title="Innovation" description="Pushing boundaries in cognitive intelligence research and fusion." />
              ...
              <div className="lg:col-span-7 space-y-10">
                 <div className="space-y-4">
                    <div className="flex flex-wrap gap-3">
                       <span className="text-[10px] font-bold text-[#004a8e] uppercase tracking-widest bg-blue-50 px-4 py-1.5 rounded-full border border-blue-100">Founder & Director</span>
                       <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest bg-white px-4 py-1.5 rounded-full border border-gray-100">NCRB Expert</span>
                    </div>
                    <h2 className="text-6xl md:text-8xl font-extrabold uppercase tracking-tighter leading-none text-gray-800 leading-tight">
                 ...
                 <div className="relative p-10 bg-white border border-gray-100 rounded-[3rem] shadow-xl shadow-blue-900/5 italic text-[#004a8e]">
                    <p className="text-gray-600 text-2xl font-medium leading-relaxed">
                       "Crimex Intelligence is not just a hub; it's a testament to digital resilience. Our goal is to forge a legacy where defense is pure instinct."
                    </p>
                 ...
                 <div className="flex flex-col sm:flex-row gap-6 pt-4">
                    <a href="https://chat.whatsapp.com/Cdr2DnpXfZAKFSr9bGunkw" target="_blank" rel="noreferrer" className="flex items-center gap-4 group">
                       ...
                       <div className="text-left">
                          <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Connect Directly</p>
                          <p className="text-sm font-bold text-gray-800 uppercase italic">Founder's Portal</p>
                       </div>
                    </a>
                 </div>
              </div>
      ...
      <footer className="mt-32 py-10 text-center border-t border-gray-100 opacity-40">
          <p className="font-bold text-[10px] text-gray-500 tracking-[0.4em] uppercase">Crimex Institutional Archive // v.3.9</p>
      </footer>
    </div>
  );
};
