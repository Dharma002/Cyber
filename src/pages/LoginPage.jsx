      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 md:p-12 bg-[#f8fafc]">
        ...
        >
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl font-extrabold text-gray-800 tracking-tight uppercase">Sign <span className="text-[#004a8e]">In</span></h2>
            <p className="text-gray-500 text-[10px] font-bold mt-2 tracking-[0.2em] uppercase">User Authentication Portal</p>
            <div className="w-12 h-1 bg-[#ffc107] mx-auto mt-4 rounded-full"></div>
          </div>

          <form className="space-y-6">
            <div className="space-y-2">
              <label className="text-[10px] font-bold text-gray-400 uppercase ml-1 tracking-widest">Official Email</label>
              <div className="relative group">
                ...
                <input 
                  ...
                  className="w-full bg-gray-50 border border-gray-100 rounded-xl py-4 pl-12 pr-4 text-sm text-gray-900 focus:outline-none focus:border-[#004a8e] focus:bg-white transition-all font-semibold"
                />
              </div>
            </div>
            ...
            <button className="w-full py-4 bg-[#004a8e] text-white rounded-xl text-[12px] font-bold uppercase tracking-[0.2em] shadow-lg shadow-blue-900/20 hover:bg-[#003366] transition-all flex items-center justify-center gap-2">
