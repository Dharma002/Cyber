...
const InfoModule = ({ label, value, icon: Icon }) => (
  <div className="flex items-center gap-4 bg-white border border-gray-100 px-6 py-4 rounded-2xl shadow-sm group hover:border-[#004a8e]/30 transition-all overflow-hidden relative">
     ...
     <div className="relative z-10">
        <p className="text-[9px] font-bold text-gray-600 uppercase tracking-[0.3em] mb-1">{label}</p>
        <p className="text-sm font-black text-gray-900 tracking-tighter uppercase">{value}</p>
     </div>
  </div>
);
...
const TacticalCard = ({ title, desc, icon: Icon, index }) => (
  ...
  >
    ...
    <div className="relative z-10">
       ...
       <h3 className="text-2xl font-black uppercase mb-4 text-gray-900 tracking-tighter group-hover:text-[#004a8e] transition-colors">{title}</h3>
       <p className="text-gray-700 text-sm leading-relaxed font-medium">{desc}</p>
           ...
           <div className="grid lg:grid-cols-2 gap-20 items-center w-full">
             ...
             >
                 <div className="inline-flex items-center gap-4 bg-white border border-gray-100 px-6 py-2 rounded-full shadow-sm">
                    ...
                    <span className="text-[9px] font-bold text-gray-600 uppercase tracking-[0.5em] italic">Auth_Node: Secure_Sync</span>
                 </div>

                 <div className="space-y-4">
                    <h1 className="text-5xl md:text-7xl font-[1000] uppercase italic tracking-tighter leading-[0.9]">
  {/* CRIMEX: Solid SIFS Blue */}
  <span className="text-[#004a8e]">
    <DecryptText text="CRIMEX" />
  </span>
  <br />
  {/* INTELLIGENCE: Gradient Blue (Navbar Style) */}
  <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-blue-400 drop-shadow-[0_0_20px_rgba(37,99,235,0.2)]">
    <DecryptText text="INTELLIGENCE" />
  </span>
</h1>
                    <p className="text-gray-700 text-lg md:text-xl font-medium tracking-tight leading-relaxed max-w-xl italic">
        ...
        <section className="space-y-16">
           <div className="flex flex-col items-center text-center">
              <h2 className="text-4xl md:text-7xl font-black uppercase italic tracking-tighter text-gray-900 leading-tight mb-4">
           ...
           <div className="flex flex-col sm:flex-row items-center justify-center gap-8 lg:gap-12">
              ...
              <a href="https://wa.me/yournumber" target="_blank" rel="noreferrer" className="flex items-center gap-4 group">
                 ...
                 <div className="text-left">
                    <p className="text-[10px] font-bold text-gray-600 uppercase tracking-widest">Support Node</p>
                    <p className="text-sm font-black text-gray-900 uppercase italic">WhatsApp Center</p>
                 </div>
              </a>
           </div>
        </section>
