      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-8">
            <motion.div 
               className="bg-white border border-gray-100 p-8 md:p-12 rounded-[3.5rem] shadow-2xl shadow-blue-900/10 relative overflow-hidden flex flex-col justify-center min-h-[600px]"
            >
                ...
                {status === 'success' ? (
                  ...
                  >
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-gray-600 text-sm font-semibold leading-relaxed max-w-sm mx-auto">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid md:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="relative">
                          <Globe className="absolute left-5 top-1/2 -translate-y-1/2 text-gray-400" size={16} />
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="relative">
                          <Briefcase className="absolute left-5 top-1/2 -translate-y-1/2 text-gray-400" size={16} />
                          ...
                          <ChevronRight className="absolute right-5 top-1/2 -translate-y-1/2 text-gray-400 rotate-90" size={14} />
                        </div>
                      </div>

                      <div className="space-y-2">
                        <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest ml-1">Select Course *</label>
                        <div className="relative">
                          <GraduationCap className="absolute left-5 top-1/2 -translate-y-1/2 text-gray-400" size={16} />
                    ...
                    <div className="pt-4">
                      ...
                      >
                        {status === 'loading' ? 'Processing...' : <><Send size={18} /> Submit Application <ArrowRight size={18} /></>}
                      </motion.button>
                    </div>
                  </form>
                )}
