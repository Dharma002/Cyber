import { Shield, Linkedin, Mail, ArrowUpRight, Terminal, Activity, Globe, MessageCircle, Instagram } from 'lucide-react';
...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-[#02040a] pt-24 pb-12 px-8 border-t border-white/5 overflow-hidden">
      ...
      {/* 1. BACKGROUND DECOR (NEON ACCENTS) */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[90%] h-[1px] bg-gradient-to-r from-transparent via-cyan-500/30 to-transparent"></div>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-16 relative z-10">
        ...
        <div className="md:col-span-5 space-y-8">
          <Link to="/" className="flex items-center gap-4 group/footer-logo">
            ...
            <div className="leading-tight">
              ...
              <div className="flex items-center gap-1.5 mt-1">
                 ...
                 <span className="text-[8px] font-mono text-cyan-500/60 tracking-[0.4em] font-bold uppercase">System_Active_v3.0</span>
              </div>
            </div>
          </Link>
          ...
          <div className="flex gap-4">
            ...
            <a 
              href="https://linkedin.com/company/crimex" 
            ...
            <a 
              href="https://instagram.com/crimex" 
              target="_blank" rel="noopener noreferrer" 
            ...
            <a 
              ...
              className="w-12 h-12 rounded-2xl bg-white/5 flex items-center justify-center border border-white/10 text-slate-400 hover:border-red-500/50 hover:text-red-500 hover:bg-red-500/5 hover:-translate-y-1 transition-all duration-300"
            >
              <Mail size={20}/>
            </a>
          </div>
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          <ul className="space-y-4 text-[11px] font-bold uppercase tracking-widest text-slate-500">
            {[
              { name: 'Training Portal', path: '/training' },
              { name: 'Case Studies', path: '/cases' },
              { name: 'Legal Docs', path: '/legal' },
        ...
        <div className="md:col-span-3">
          <div className="p-8 rounded-[2rem] bg-[#0d0d12] border border-white/5 relative overflow-hidden group shadow-2xl">
            {/* Animated background pulse inside card */}
